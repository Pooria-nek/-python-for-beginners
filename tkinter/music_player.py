...
Label(root, text="Menu", bg="#0f1a2b").pack(padx=10, pady=50, side=RIGHT)

# Button
# Button_Play = PhotoImage(file="play.png")
# Button(root, image=Button_Play, bg="#0f1a2b", bd=0, command=Play_Music).place(x=100, y=400)
Button(root, text="Button_Play", bg="#0f1a2b", bd=0, command=Play_Music).place(x=100, y=400)
...
Button(root, text="Button_Stop", bg="#0f1a2b", bd=0, command=mixer.music.stop).place(x=30, y=500)
...
Button(root, text="Button_Resume", bg="#0f1a2b", bd=0, command=mixer.music.unpause).place(x=115, y=500)
...
Button(root, text="Button_Pause", bg="#0f1a2b", bd=0, command=mixer.music.pause).place(x=200, y=500)
